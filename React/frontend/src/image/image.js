const Images = {
    ...
    funds__table: require('./navigation/fundsTable.webp'),
    users: require('./navigation/users.webp'),
    cabinet: require('./navigation/cabinet.webp'),
    exit: require('./navigation/exit.webp'),
    login: require('./navigation/login.webp'),
